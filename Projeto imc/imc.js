...
function calculaIMC(){
    ...
    }else if(imc < 39.9 &&  faixa_etaria === 'adulto'){
    ...
    resultado.innerHTML = `<p class="${classe}" >Resultado 
     <br> ${faixa_etaria === 'adulto' ? 'adulto' : "idoso"} ${altura}m ${peso}kg 
     <br> IMC = ${(imc)} 
     <br> Classificação ${classificacao} 
     <br>Peso ideal: ${peso_minimo}kg - ${peso_maximo}kg </p>`;
